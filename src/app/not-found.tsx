...
import { Smartphone, ArrowLeft, HelpCircle } from "lucide-react";
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-6 z-10 py-16">
        ...
        >
          ...
          <p className="text-sm text-text-muted leading-relaxed">
            The page you are looking for has been disconnected or moved to another directory. Let&apos;s get you back to our repair diagnostic bay.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full mt-4 justify-center">
            ...
            >
              <HelpCircle className="w-4 h-4" /> Visit FAQs
            </Link>
          </div>
        </motion.div>
      </main>
